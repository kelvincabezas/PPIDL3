...
def display():
    ...
    if X is not None and y is not None:
        if len(X) > 1:
            ...
            st.markdown('<p style="color:#2B6CB0;font-weight: bold;">Este gráfico compara nuestras predicciones con los valores reales observados. Si los puntos se alinean bien con la línea diagonal, significa que nuestro modelo está haciendo un buen trabajo prediciendo el volumen de captura.</p>', unsafe_allow_html=True)
